    ...
    internal class Program
    {
        ...
        public void EmployeeCheck()
        {
            ...
            try
            {
                ...
                {
                    server.Open();
                    string queryCheck = "SELECT fullname, id  FROM employeedata;";
                    ...
                    using (SqlDataReader reader = payExec.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            {
                                Console.WriteLine($"{name} is currently working");
                                working = true;
                            }

                        }
                        if (working == false) { Console.WriteLine("No employee working at the moment"); }
                    }
        ...
        public void StartWatch()
        {
            ...
            if (File.Exists(Code + ".txt")) { Console.WriteLine("You haven't Logged out of previous work"); }
            else {
        ...
        public void StopWatch()
        {
            ...
            else { Console.WriteLine("You haven't started work to end"); }
        }
                ...
                switch (reading)
                {
                    ...
                    case "2":
                        ...
                        program.CheckAdmin(read);
                            ...
                            Console.WriteLine("10) Check working employees"); // This will have problems rectify after changing to db
